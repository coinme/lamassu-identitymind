...
function stage1Verify(data, cb) {
    ...
    console.log('Verifying user:%s', JSON.stringify(data));
...
function _normalizeData(rawData) {
    ...
    data = {
        bfn: license.DCT || license.DAC, // First name
        bln: license.DCS, // Last name
        dob: dob, // Date of birth
        bsn: license.DAG, // address
        bc: license.DAI, // City
        bs: license.DAJ, // State
        bz: license.DAK, // Zip code
        bco: country, //
        man: man,
        stage: 1
    };
